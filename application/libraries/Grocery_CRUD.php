...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path				= 'asset/grocery_crud/languages';
	protected $default_config_path					= 'asset/grocery_crud/config';
	protected $default_asset_path					= 'asset/grocery_crud';
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	...
	protected function _initialize_variables()
	{
		...
		$this->default_javascript_path				= $this->default_asset_path.'/js';
		$this->default_css_path						= $this->default_asset_path.'/css';
		$this->default_texteditor_path 				= $this->default_asset_path.'/texteditor';
		$this->default_theme_path					= $this->default_asset_path.'/themes';
	...
	public function set_field_upload($field_name, $upload_dir = '')
	{
		$upload_dir = !empty($upload_dir) && substr($upload_dir,-1,1) == '/'
						...
						: $upload_dir;
		$upload_dir = !empty($upload_dir) ? $upload_dir : 'asset/uploads/files';
